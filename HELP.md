...
* The original package name 'com.blastza.platform.authorization-server' is invalid and this project uses 'com.blastza.platform.authorization_server' instead.
